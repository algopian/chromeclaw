/**
 * Strip thinking blocks from assistant messages for providers that don't support them.
 *
 * Ported from OpenClaw's pi-embedded-runner/thinking.ts.
 */
...
export const isAssistantMessageWithContent = (message: AgentMessage): message is AssistantMessage =>
  !!message &&
 ...
 */
export const dropThinkingBlocks = (messages: AgentMessage[]): AgentMessage[] => {
  let touched = false;
