/**
 * DeepSeek MAIN world content script — extracted from content-fetch-main.ts.
 *
 * Injected via chrome.scripting.executeScript into the MAIN world of a
 * DeepSeek tab. Performs fetch() with the user's session cookies, solves
 * Proof-of-Work challenges (SHA-256 / DeepSeekHashV1), and streams SSE
 * chunks back to the extension via window.postMessage().
 *
