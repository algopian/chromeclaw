 ...
 *
 * This file contains shared setup (pre-flight requests, template substitution)
 * and shared infrastructure (Connect Protocol binary framing, standard SSE streaming).
 * Provider-specific handlers have been extracted into separate content-fetch-*.ts files.
 */
