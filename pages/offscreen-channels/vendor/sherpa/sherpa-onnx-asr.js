...
// Browser export: loaded as a classic script from the offscreen document, this
// wrapper's classes are lexically scoped and the Node module.exports guard
// above is skipped. Expose OfflineRecognizer on the global so the SenseVoice
// worker can construct it (it is not a Module member).
